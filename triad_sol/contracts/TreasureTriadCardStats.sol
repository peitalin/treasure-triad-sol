...
contract TreasureTriadCardStats {
    ...
    function getCard(TreasureCard calldata _card) public view returns (CardStats memory) {
        return cards[_card.tcard];
    }

    function _addInitialManyCards(CardStats[47] memory arr) private {
    ...
    function _addCard(CardStats memory c) private returns (CardStats memory) {
        ...
        return addCard(c.name, c.n, c.e, c.s, c.w, c.tokenId);
    }
